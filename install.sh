...
kubectl apply -f ./k8s-defs/service-account/server-certs-admin.yaml
kubectl apply -f ./k8s-defs/cluster-role/kube-system-csr-admin.yaml
kubectl apply -f ./k8s-defs/role-binding/kube-system-server-certs-admin-secret-manager.yaml
kubectl apply -f ./k8s-defs/cluster-role-binding/kube-system-server-certs-admin-admin-csr.yaml
